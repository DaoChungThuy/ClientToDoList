        ...
        <el-col :span="12">
            ...
            <el-form ref="taskForm" :model="task" label-width="120px">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <el-form-item>
                            <el-button type="primary" @click="updateTask()">Update Task</el-button>
                        </el-form-item>
                    </div>
...
const getTaskEdit = async () => {
    try {
        const response = await axios.get(`/to_do/${route.params.id}`);
        Object.keys(task.value).forEach((key) => {
            if (Object.prototype.hasOwnProperty.call(response.data.data, key)) {
                (task.value as any)[key] = response.data.data[key];
            }
        });
...
const updateTask = async () => {
    try {
        ...
        await axios.put(`/update_to_do/${route.params.id}`, convertedTask)
